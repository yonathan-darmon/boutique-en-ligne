...
class HistoriqueModel extends Model
{
    ...
    public function getHisto($value) // Requète pour avoir l'historique des commandes 
    {
    ...
    public function insert($product_name, $quantity, $prices, $moyen_de_paiement, $id_commande, $id_user) // Requète pour ajouter l'historique
    {
    ...
    public function updatePrice($value,$nom) // Permet de ne pas modifier la valeur de l'historique si un prix change
    {
    ...
    public function sumPay($id) // Utilisé pour appliquer les rewards
    {
